...
#define sys_port_trace_k_timer_status_sync_enter(timer) sys_trace_k_timer_status_sync_enter(timer)
...
#define sys_port_trace_socket_close_enter(sock)         sys_trace_socket_close_enter(sock)
#define sys_port_trace_socket_close_exit(sock, ret)     sys_trace_socket_close_exit(sock, ret)
#define sys_port_trace_socket_shutdown_enter(sock, how) sys_trace_socket_shutdown_enter(sock, how)
#define sys_port_trace_socket_shutdown_exit(sock, ret)  sys_trace_socket_shutdown_exit(sock, ret)
#define sys_port_trace_socket_bind_enter(sock, addr, addrlen)                                      \
	sys_trace_socket_bind_enter(sock, addr, addrlen)
#define sys_port_trace_socket_bind_exit(sock, ret) sys_trace_socket_bind_exit(sock, ret)
#define sys_port_trace_socket_connect_enter(sock, addr, addrlen)                                   \
	sys_trace_socket_connect_enter(sock, addr, addrlen)
#define sys_port_trace_socket_connect_exit(sock, ret) sys_trace_socket_connect_exit(sock, ret)
#define sys_port_trace_socket_listen_enter(sock, backlog)                                          \
	sys_trace_socket_listen_enter(sock, backlog)
#define sys_port_trace_socket_listen_exit(sock, ret) sys_trace_socket_listen_exit(sock, ret)
#define sys_port_trace_socket_accept_enter(sock)     sys_trace_socket_accept_enter(sock)
...
#define sys_port_trace_socket_sendto_exit(sock, ret) sys_trace_socket_sendto_exit(sock, ret)
#define sys_port_trace_socket_sendmsg_enter(sock, msg, flags)                                      \
	sys_trace_socket_sendmsg_enter(sock, msg, flags)
#define sys_port_trace_socket_sendmsg_exit(sock, ret) sys_trace_socket_sendmsg_exit(sock, ret)
...
#define sys_port_trace_socket_fcntl_exit(sock, ret)  sys_trace_socket_fcntl_exit(sock, ret)
#define sys_port_trace_socket_ioctl_enter(sock, req) sys_trace_socket_ioctl_enter(sock, req)
#define sys_port_trace_socket_ioctl_exit(sock, ret)  sys_trace_socket_ioctl_exit(sock, ret)
#define sys_port_trace_socket_poll_enter(fds, nfds, timeout)                                       \
	sys_trace_socket_poll_enter(fds, nfds, timeout)
#define sys_port_trace_socket_poll_exit(fds, nfds, ret) sys_trace_socket_poll_exit(fds, nfds, ret)
...
#define sys_port_trace_socket_setsockopt_exit(sock, ret) sys_trace_socket_setsockopt_exit(sock, ret)
#define sys_port_trace_socket_getpeername_enter(sock)    sys_trace_socket_getpeername_enter(sock)
...
#define sys_port_trace_socket_getsockname_enter(sock) sys_trace_socket_getsockname_enter(sock)
...
#define sys_port_trace_net_recv_data_enter(iface, pkt) sys_trace_net_recv_data_enter(iface, pkt)
#define sys_port_trace_net_recv_data_exit(iface, pkt, ret)                                         \
	sys_trace_net_recv_data_exit(iface, pkt, ret)
#define sys_port_trace_net_send_data_enter(pkt)     sys_trace_net_send_data_enter(pkt)
#define sys_port_trace_net_send_data_exit(pkt, ret) sys_trace_net_send_data_exit(pkt, ret)
#define sys_port_trace_net_rx_time(pkt, end_time)   sys_trace_net_rx_time(pkt, end_time)
#define sys_port_trace_net_tx_time(pkt, end_time)   sys_trace_net_tx_time(pkt, end_time)
