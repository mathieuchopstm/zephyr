...
/**
 * NOTE: these tables are made visible externally (not "static")
 * to allow re-use from other places (not clean, but OK for now)
 *
 * TODO: are these values valid for all series?
 */
...
const uint8_t apbpre_to_shift_table[] = {
	/* 0b100:  2 = 2^1 */ 1,
	/* 0b101:  4 = 2^2 */ 2,
	/* 0b110:  8 = 2^3 */ 3,
	/* 0b111: 16 = 2^4 */ 4
