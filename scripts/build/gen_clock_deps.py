...
def main():
    ...
    with open(args.output_source, "w") as fp:
        fp.write("/* AUTO-GENERATED by gen_clock_deps.py, do not edit! */\n")
        ...
        for ord_num, child_ords in parsed_elf.clock_ordinal_arrays.items():
            ...
            fp.write(f"/* Ordinal {ord_num}: {edt.dep_ord2node[ord_num].path} */\n")
            fp.write(f"const clock_handle_t {sym_name}[] ={{\n\t")
            for child_handle in child_ords.handles:
                child_dt_ordinal = child_ords._handle2ordinal[child_handle]
                child_node = edt.dep_ord2node[child_dt_ordinal]
                fp.write(f"{child_handle},\t\t/* {child_dt_ordinal}: {child_node.path} */\n\t")
            fp.write("CLOCK_LIST_END\n};\n\n")
